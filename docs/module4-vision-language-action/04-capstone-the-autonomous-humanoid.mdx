...
<WhatYouWillLearn
  goals={[
    {
      text: "Integrate Vision, Language, and Action into a complete robot system",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Deploy an end-to-end VLA pipeline from voice command to physical execution",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Handle real-world challenges in multi-modal robot control",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Demonstrate mastery of Physical AI concepts from all four modules",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
