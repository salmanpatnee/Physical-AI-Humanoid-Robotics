...
<WhatYouWillLearn
  goals={[
    {
      text: "Configure collision properties for realistic object interactions",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Understand and modify gravity settings for different environments",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Add and configure sensors in Gazebo robot models",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Visualize sensor data in real-time",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
