...
<WhatYouWillLearn
  goals={[
    {
      text: "Understand why Unity complements Gazebo for robotics simulation",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Learn to import robot models (URDF) into Unity",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Create photorealistic scenes using Unity's rendering capabilities",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Design interactive scenarios for human-robot interaction",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
