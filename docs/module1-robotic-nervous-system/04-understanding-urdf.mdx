...
<WhatYouWillLearn
  goals={[
    {
      text: "Understand the Unified Robot Description Format (URDF)",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Learn how to model humanoid robot structure and kinematics",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Define links, joints, and kinematic chains",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Visualize robot models in RViz and simulation",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
