...
<WhatYouWillLearn
  goals={[
    {
      text: "Understand Visual SLAM (VSLAM) and its role in robot localization",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Deploy GPU-accelerated Isaac ROS packages on NVIDIA Jetson hardware",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Build real-time 3D maps using stereo vision and depth cameras",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Integrate VSLAM with ROS 2 navigation stacks for autonomous operation",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
...
<GrownUpWords
  terms={[
    ...
    {
      simple_term: "Announcer",
      technical_term: "Publisher",
      context_example: "This chapter discusses Publisher in detail."
    },
    {
