...
<WhatYouWillLearn
  goals={[
    {
      text: "Understand the role of advanced perception in embodied intelligence",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Learn how synthetic data generation accelerates robot AI training",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Recognize the challenges of sim-to-real transfer in robotics",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Explore the architecture of AI-powered robotic perception systems",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
