...
<WhatYouWillLearn
  goals={[
    {
      text: "Understand the Nav2 navigation stack architecture and components",
      icon: "Target",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Configure Nav2 for humanoid robot locomotion and bipedal constraints",
      icon: "Lightbulb",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Implement behavior trees for complex navigation tasks",
      icon: "Rocket",
      why_it_matters: "This is important for building real robots!"
    },
    {
      text: "Deploy end-to-end navigation from Isaac Sim simulation to Jetson hardware",
      icon: "CheckCircle2",
      why_it_matters: "This is important for building real robots!"
    }
  ]}
...
<GrownUpWords
  terms={[
    ...
    {
      simple_term: "Map-making with camera",
      technical_term: "VSLAM",
      context_example: "This chapter discusses VSLAM in detail."
    }
  ]}
  displayStyle="table"
/>
